...
import (
	...
	"exchange-system/rpc/matching/internal/config"
	"exchange-system/rpc/matching/internal/server"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		matching.RegisterMatchingServer(grpcServer, server.NewMatchingServer(ctx))
